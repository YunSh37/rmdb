...
- 代码注释与文档统一使用**中文**
- 不修改已有公共接口（除非文档明确允许）
- 如需了解详细架构，参考 `RMDB项目结构.pdf`
- 建议每通过一个测试点就提交：`git commit -m "pass: 题目号-测试点号"`

## 文档索引

| 文档 | 内容 |
|------|------|
| `RMDB项目结构.pdf` | 架构详解、模块说明 |
| `RMDB使用文档.pdf` | 编译运行详细指南 |
| `框架图.pdf` | 系统框架图 |
| `测试说明文档v3.0.md` | 全部测试点规格说明 |
| `数据一致性检验规则.md` | 一致性检验规则 |
| `project_analysis.md` | 模块代码分析 |
